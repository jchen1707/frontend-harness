...
6. **Plan status.** `.agents/plans/plan.md` (when this work used one) has its `Status:`
...
Append one line per run to `.agents/plans/preflight-ledger.md` (gitignored; create it with
